...
//testcolor(RED);
gotoxy(1,1);
cprintf("LIST OF EMPLOYEES RECORD");
//testcolor(GREEN);
gotoxy(1,2);
cprintf("EMP ID");
gotoxy(14,2);
...
setcolor(WHITE);
settextstyle(7,0,3);
outtextxy(85,190,"EMPLOYEES RECORD MANAGEMENT SYSTEM");
//settextcolor(1,0,1);
...
setcolor(WHITE);
settextstyle(7,0,3);
outtextxy(130,45,"EMPLOYEES RECORD MANAGEMENT");
settextstyle(7,0,3);
setcolor(YELLOW);
...
outtextxy(200,170,"2>>LIST RECORDS OF ALL EMPLOYEES.");
